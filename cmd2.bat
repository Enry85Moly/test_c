...
rem Compila tutti i file sorgente .c nella main root del progetto
for %%i in ("*.c") do (
    gcc -pipe -std=c11 -w -ggdb -c -fpermissive -malign-double -O%2 -x c "%%i" -o ".\work\%%~ni.o"
)

if errorlevel 1 goto end

rem Ottieni tutti i nomi dei file .o nella sotto-directory work del progetto
set files=
for %%f in (".\work\*.o") do (
